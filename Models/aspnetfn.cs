...
public partial class chatbot {
    ...
    public static void SetupMenus()
    {
        ...
        List<MenuItem> menuItems = [
            new(1, "mi_Question", "QuestionList", -1, "{F74BDC2E-8C3F-45C8-A887-A125D888F9A0}Question", false, false, "", "", false, true),
            new(2, "mi_Chatting", "Chatting", -1, "{F74BDC2E-8C3F-45C8-A887-A125D888F9A0}Chatting", false, false, "", "", false, true),
        ];
        ...
        foreach (AdvancedFilter filter in fld.AdvancedFilters) {
            if (filter.ID == fldVal && filter.Enabled) {
                ...
                if (!Empty(method))
                    ...
                    wrk = ConvertToString(typeof(chatbot).GetMethod(method)?.Invoke(null, [exp, dbid]));
                break;
            }
        }
        return wrk;
    ...
    */
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(chatbot).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(chatbot).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
