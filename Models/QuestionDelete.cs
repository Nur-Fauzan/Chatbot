...
public partial class chatbot {
    ...
    /// questionDelete
    /// </summary>
    public static QuestionDelete questionDelete
    {
        get => HttpData.Get<QuestionDelete>("questionDelete")!;
        set => HttpData["questionDelete"] = value;
    }

    /// <summary>
    /// Page class for Question
    /// </summary>
    public class QuestionDelete : QuestionDeleteBase
    {
        // Constructor
        public QuestionDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public QuestionDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class QuestionDeleteBase : Question
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "questionDelete";
        ...
        // Page name
        public string PageName => "QuestionDelete";
        ...
        // Constructor
        public QuestionDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("QuestionList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("QuestionList"); // Return to list
                }
            }
