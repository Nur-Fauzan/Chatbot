...
public partial class chatbot {
    ...
    /// questionView
    /// </summary>
    public static QuestionView questionView
    {
        get => HttpData.Get<QuestionView>("questionView")!;
        set => HttpData["questionView"] = value;
    }
    ...
    {
        // Constructor
        public QuestionView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public QuestionView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class QuestionViewBase : Question
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "questionView";
        ...
        // Page name
        public string PageName => "QuestionView";
        ...
        // Constructor
        public QuestionViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "QuestionList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("QuestionList"); // Return to list page
                            }
                        }
                    break;
            }
