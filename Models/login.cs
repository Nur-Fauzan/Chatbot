...
public partial class chatbot {
    ...
    public class LoginBase : AspNetMakerPage
    {
        ...
        public DbField<SqlDbType> LoginUsername = new("login", "username", 202, SqlDbType.NVarChar) {
                TableName = "login",
                Name = "username",
                Expression = "username"
            }; // DN

        public DbField<SqlDbType> LoginPassword = new("login", "password", 202, SqlDbType.NVarChar) {
                TableName = "login",
                Name = "password",
                Expression = "password"
            }; // DN

        public DbField<SqlDbType> LoginType = new("login", "type", 202, SqlDbType.NVarChar) {
                TableName = "login",
                Name = "logintype",
