...
public partial class chatbot {
    ...
    public static partial class Config
    {
        ...
        public const string ProjectClassName = "ASPNETMaker2024.Models.chatbot"; // DN
        ...
        public const string ProjectName = "chatbot"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{F74BDC2E-8C3F-45C8-A887-A125D888F9A0}"; // Project ID (GUID)

        public static string RandomKey = "mttcm95JhdUb6Zp3"; // Random key for encryption // DN

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/chatbot.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        // Export Log
        public static string ExportPath = "export-f74bdc2e-8c3f-45c8-a887-a125d888f9a0"; // Export folder
        ...
        public static string AdminUserName = "AdminChatbot"; // Administrator user name

        public static string AdminPassword = "Password123"; // Administrator password
