...
public partial class chatbot {
    ...
    {
        get => HttpData.Resolve<Question>("Question");
        set => HttpData["Question"] = value;
    }

    /// <summary>
    /// Table class for Question
    /// </summary>
    public class Question : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Question2;

        public readonly DbField<SqlDbType> Answer;

        public readonly DbField<SqlDbType> Tag;
        ...
        public Question()
        {
            ...
            Name = "Question";
            Type = "TABLE";
            UpdateTable = "dbo.Question"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new(this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Question", "ID", "CustomMsg"),
                IsUpload = false
            };
            ID.Raw = true;
            Fields.Add("ID", ID);
            ...
            // Question
            Question2 = new(this, "x_Question2", 202, SqlDbType.NVarChar) {
                Name = "Question",
                Expression = "[Question]",
                UseBasicSearch = true,
                ...
                CustomMessage = Language.FieldPhrase("Question", "Question2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Question", Question2);

            // Answer
            Answer = new(this, "x_Answer", 203, SqlDbType.NText) {
                Name = "Answer",
                Expression = "[Answer]",
                BasicSearchExpression = "[Answer]",
                DateTimeFormat = -1,
                VirtualExpression = "[Answer]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Question", "Answer", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Answer", Answer);

            // Tag
            Tag = new(this, "x_Tag", 202, SqlDbType.NVarChar) {
                Name = "Tag",
                Expression = "[Tag]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Tag]",
                DateTimeFormat = -1,
                VirtualExpression = "[Tag]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Question", "Tag", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Tag", Tag);
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.Question type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Question2.DbValue = row["Question"]; // Set DB value only
                Answer.DbValue = row["Answer"]; // Set DB value only
                Tag.DbValue = row["Tag"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "QuestionView" => Language.Phrase("View"),
                "QuestionEdit" => Language.Phrase("Edit"),
                "QuestionAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QuestionView",
                Config.ApiAddAction => "QuestionAdd",
                Config.ApiEditAction => "QuestionEdit",
                Config.ApiDeleteAction => "QuestionDelete",
                Config.ApiListAction => "QuestionList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QuestionList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QuestionView", parm);
            else
                url = KeyUrl("QuestionView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QuestionAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QuestionEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QuestionList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QuestionAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QuestionList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("QuestionDelete", parm)); // DN
        }
        ...
        public async Task RenderEditRow()
        {
            ...
            Question2.EditValue = Question2.CurrentValue;
            ...
            Tag.EditValue = Tag.CurrentValue;
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(Question2);
                        doc.ExportCaption(Answer);
                        doc.ExportCaption(Tag);
                    } else {
                        doc.ExportCaption(Question2);
                        doc.ExportCaption(Tag);
                    }
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(Question2);
                            await doc.ExportField(Answer);
                            await doc.ExportField(Tag);
                        } else {
                            await doc.ExportField(Question2);
                            await doc.ExportField(Tag);
                        }
